...
const ProfessionalPage = ({ setCurrentPage }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 text-gray-900 dark:text-slate-100 transition-colors duration-300 overflow-hidden">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-800/90 backdrop-blur-md border-b border-gray-200 dark:border-slate-600 shadow-sm">
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center relative bg-white dark:bg-slate-900">
        <div className="text-center z-10 px-6">
          <div className={`transform transition-all duration-1000 ${isVisible.hero ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-2xl md:text-3xl mb-4 text-gray-600 dark:text-slate-300 font-light">
              Software Engineer
            </p>
